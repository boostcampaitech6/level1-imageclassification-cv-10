...
def inference(data_dir, model_dir, output_dir, args):
    ...
    with torch.no_grad():
        for idx, images in enumerate(loader):
            ...
            age_output, mask_output, gender_output = model(images)
            ...
            pred = age_output + gender_output*3 + mask_output*6

            preds.extend(pred.cpu().numpy())

    info['ans'] = preds
    info.to_csv(os.path.join(output_dir, f'{args.exp_name}_output.csv'), index=False)
